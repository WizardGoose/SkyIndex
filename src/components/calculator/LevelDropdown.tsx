      ...
      <div className="relative" ref={dropdownRef}>
        ...
        <div className="relative">
          <button
            ...
            className={`w-full px-3 py-2 pr-10 bg-white/5 border border-white/10 rounded-md text-white text-sm cursor-pointer hover:border-white/20 hover:bg-white/10 transition-all duration-200 text-left ${FOCUS}`}
          >
            Level {value}
          </button>
